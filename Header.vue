<template>
 ...
 <img src="https://png.icons8.com/windows/32/000000/menu.png" datatoggle="dropdown" data-target="#navd" aria-haspopup="true" aria-expanded="false">
 ...
 <div class="user">
 <h5 style="cursor: pointer" data-toggle="modal" data-target="#userModal">Sign
In</h5>
 </div>
 ...
 <!--User Modal-->
 <div class="modal fade" id="userModal" role="dialog" arialabelledby="exampleModalLabel" aria-hidden="true">
 <div class="modal-dialog" role="document">
 <div class="modal-content">
 <div class="modal-body">
 <button type="button" class="close" data-dismiss="modal" style="outline-style:none;"
aria-label="Close">
 <span>x</span>
58
 </button>
